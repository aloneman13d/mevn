  ...
  <div class="grid gap-8 bg-slate-100 md:grid-cols-2 md:items-center w-full p-5 overflow-auto max-h-screen ">
    <div class=" bg-white text-center p-8 rounded-md drop-shadow-2xl">
        ...
        <nav class="mt-8">
          ...
          <router-link to="/login" class="bg-slate-300 shadow-slate-600 shadow-md  hover:bg-sky-500 mx-3 my-4 px-3 py-1 rounded-md hover:text-slate-200">ลงชื่อเข้าใช้</router-link>
