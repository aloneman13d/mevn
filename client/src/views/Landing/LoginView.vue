  ...
  <session class="">
    <form class="login-form">
      <div class="grid content-center max-h-full h-screen">
        <div class="grid content-center md:grid-cols-2 w-9/12 border-white border mx-auto rounded-lg">
          <div class="hidden md:flex items-center bg-white">
            <img class=" max-w-full md:rounded-l-lg "
          ...
          <div class="py-20 px-10 bg-white">
            ...
            <div class="relative text-gray-600 focus-within:text-gray-400">
              <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                <svg stroke="currentColor" class="w-4 h-4 fill-slate-400" viewBox="0 0 1920 1920"
            ...
            <div class="relative text-gray-600 focus-within:text-gray-400">
              <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                <svg class="w-5]4 h-4 fill-none stroke-slate-400 stroke-2" viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <input type="button" value="Login"
              class="rounded-2xl py-1 block bg-slate-800 text-white my-8 w-11/12 mx-auto" />
            <div class="flex items-center py-4">
              <!-- The left line -->
              <div class="flex-grow h-px bg-gray-300"></div>

              <!-- Your text here -->
              <span class="flex-shrink text-xs text-gray-400 px-4 italic font-light">or</span>
